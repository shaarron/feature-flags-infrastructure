...
A collection of Terraform configurations that provision AWS infrastructure for [feature-flags-service]([feature-flags-app](https://github.com/shaarron/feature-flags-service)).
